...
/**
 * Implements an Ingress builder that generates Ingress resources suitable for the NGINX Inc. Ingress Controller.
 *
 * https://docs.nginx.com/nginx-ingress-controller/
 */
public class NginxIncIngressBuilder extends AbstractIngressBuilder {
    ...
    public NginxIncIngressBuilder(TargetState targetState, String name, String hostname, IngressTls tls) {
