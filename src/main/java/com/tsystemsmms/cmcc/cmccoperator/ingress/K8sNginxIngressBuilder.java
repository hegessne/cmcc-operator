...
/**
 * Implements an Ingress builder that generates Ingress resources suitable for the Kubernetes NGINX Ingress Controller.
 *
 * https://kubernetes.github.io/ingress-nginx/
 */
public class K8sNginxIngressBuilder extends AbstractIngressBuilder {
    ...
    public K8sNginxIngressBuilder(TargetState targetState, String name, String hostname, IngressTls tls) {
